    ...
    <div className="navbar-start">
      ...
      <a className="">
        <img
          ...
          src="https://suplar.com/wp-content/uploads/2021/10/SuplarLogoFooterSmaller.png"
        />
      </a>
    </div>
    <div className="navbar-center hidden lg:flex">
      <div className="form-control">
        <input
          type="text"
          placeholder="Search"
          className="input border-2 rounded-full bg-gray-800 border-gray-500 text-xl text-white text-opacity-30"
        />
      </div>
    </div>
