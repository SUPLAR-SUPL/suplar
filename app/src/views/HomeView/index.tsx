...
export const HomeView: FC = ({}) => {
  ...
  return (
    <>
      ...
      <div
        className="relative bg-gray-800 rounded-3xl border-black"
        style={{ width: 1002, height: 273 }}
      >
        <p
          className="w-72 h-9 absolute text-xl font-extrabold text-white"
          style={{ left: 233.19, top: 38.01 }}
        >
          Suplar #011
        </p>
        <p
        ...
        <p
          className="w-72 h-8 absolute text-xl font-extrabold text-white"
          style={{ left: 233, top: 208 }}
        >
          goog25-aapl25-sp50
        </p>
        <p
          className="w-8 h-8 absolute text-xl font-light text-center text-white"
          style={{ left: 862.49, top: 34.63 }}
        >
          321{" "}
        </p>
        <div
          className="relative absolute -space-x-4"
          style={{ width: 285.81, height: 62.15, left: 233.19, top: 110.85 }}
        >
          <img
        ...
        <div
          className="w-52 h-14 absolute"
          style={{ left: 748.45, top: 197.62 }}
        >
          <div className="flex items-center justify-center flex-1 h-full px-4 py-4 bg-gray-800 border-2 rounded-full border-pink-600">
            <p className="flex-1 h-full text-xl font-medium text-center text-white">
              Join the fund
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col lg:grid lg:gap-4 2xl:gap-6 lg:grid-cols-4 2xl:row-span-2 2xl:pb-8 ml-2 pt-4 px-6">
        ...
        <div className="bg-gray-800 rounded-3xl border-black lg:order-1 lg:row-span-1 2xl:row-span-1 lg:col-span-3 rounded-lg shadow-xl mb-5 lg:mb-0">
        ...
        <div className="bg-gray-900 lg:order-2 lg:row-span-1 2xl:row-span-1 lg:col-span-1 rounded-lg shadow-xl pb-4 mb-5 lg:mb-0">
          ...
          <div
            className="bg-gray-600 rounded-3xl border-black py-8"
            style={{ width: 464, height: 855 }}
          >
            <div className="mx-8 2xl:mx-10 my-10">
              <p className=" h-8 md:h-9 2xl:h-20 h-9 text-4xl font-extrabold text-white -ml-1 -mt-2 lg:-mt-4">
                Fund Joined
              </p>
              <div
                className="transform -rotate-1 bg-black bg-opacity-20 border-gray-400"
                style={{ width: 418.02, height: 1 }}
              />
            </div>

            <div className="relative" style={{ width: 412, height: 74 }}>
              <div
                className="relative w-12 h-12 absolute"
                style={{ left: 257.76, top: 2.5 }}
              >
                <div className="w-full h-full bg-yellow-400 bg-opacity-20 rounded-full" />
              </div>
              <p className="w-20 h-8 absolute right-0 top-0 text-3xl font-medium text-white">
                1.6%
              </p>
              <p className="w-40 h-12 absolute left-0 top-0 text-3xl font-extrabold text-white">
                SUPL XYZ
              </p>
              <p className="w-72 h-8 absolute left-0 bottom-0 text-xl text-gray-400">
                400 members
              </p>
            </div>
